...
// PRODUCTION PROFILE: Aggressive — validates deduplication under heavy load
...
export function teardown() {
  console.log('✅ Idempotency (production): 500 requests with same key — no duplicates created');
}
