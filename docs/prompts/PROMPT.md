# KIRO SPEC MODE PROMPT — MENTORING SESSION BOOKING SYSTEM
## System Design Exercise | Mentoring Session Booking System
## Candidate: Gowthamvel Palanivel
## Date: 2026-08-11
## Tools: Kiro (agentic IDE), AI-assisted spec-driven development
...
Build a full-stack mentoring session booking app for a mentoring platform 
(enterprise mentoring platform).

Working app via docker-compose. README. Technical walkthrough.

Key constraint: Demonstrate AI-assisted development — how I drive and 
correct AI, architectural reasoning, and decision-making.
...
**My doubt:** The mentoring platform industry heavily uses Rails. Convention-over-configuration might 
...
| Dev speed | Immediate | 1-2h understanding RSC quirks |
...
| MVP complexity | Low | Medium | Deceptively simple |
...
|----------|--------|-------------|-----|
| Delivery confidence | 40% | 5/5 | Daily Rails user (Nextpoint monolith), built Calendly-class scheduling platform in Rails, Sidekiq migration expert |
...
| Domain alignment | 20% | 5/5 | Enterprise mentoring platforms commonly use Rails; demonstrates production readiness |
